...
function HowItWorksSnippet({ title, description, image, flipImage }) {
  ...
  const textClasses = isVisible
    ? flipImage
      ...
      : "flex items-center text-center w-1/2 text-2xl p-10 opacity-0 transition-opacity-transform duration-1000 delay-1000 opacity-100 shadow-2xl border rounded-lg"
  ...
  return (
    <div ref={containerRef} className={containerClasses}>
      ...
      <div className={textClasses}>
        <p
          className={
            flipImage ? "shadow-2xl border rounded-lg p-5 text-center" : ""
          }
        >
          {description}
        </p>
