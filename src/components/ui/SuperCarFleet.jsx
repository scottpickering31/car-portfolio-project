function SuperCarFleet() {
  ...
  return (
    <div className="z-10 flex justify-start items-center relative font-genos">
      ...
      <div className="text-lg text-center text-white flex flex-col items-center gap-5 transform mobile:p-2 mobile:justify-normal mobile:text-sm mobile:w-full mobile:h-full mobile:bg-customBrown/50 mobile:left-1/2 mobile:overflow-auto mobile:-translate-x-1/2 mobile:rounded-none desktop:left-1/3 desktop:text-lg desktop:justify-center desktop:overflow-hidden desktop:h-full desktop:w-1/3 desktop:-translate-x-1/2 desktop:p-2 desktop:rounded-lg desktop:bg-customBrown/90 absolute mobilelg:p-5 tablet:text-base laptop:text-base laptop:w-1/2 widescreen:text-xl widescreen:p-1 tablet:overflow-hidden laptop:overflow-hidden">
        <p>
