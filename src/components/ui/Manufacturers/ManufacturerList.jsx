...
function ManufacturerList({ setSelectedManufacturer }) {
  ...
  return (
    <div className="flex flex-col justify-evenly items-center mobile:mt-5 mobilelg:mt-5 tablet:mt-5 laptop:mt-0 desktop:mt-0 mobile:w-full mobilelg:w-full tablet:w-full laptop:w-full desktop:w-full">
      <h1 className="bg-customBlue shadow-2xl font-roboto text-center text-white font-semibold tracking-widest rounded-2xl mobile:text-base mobile:w-11/12 mobile:mb-0 mobile:p-2 tablet:text-2xl laptop:text-2xl desktop:text-2xl desktop:w-1/2 desktop:p-5 desktop:mb-5">
